...
_start:
   ...
   mov  r2, #0xB4          // store ‭the value 0000100‬ in r2, this value is used
   ...
   mov  r2, #0x90          // store the value 0100 in r2

   mov  r3, #0x24          // store the value 0100 in r2

mainloop:
   strb r2, [r0]           // store the value in r2 in the memory address [r0]
   strb r3, [r1]           // store the value in r2 in the memory address [r1]
   bl dowait               // execute dowait
   strb r2, [r1]           // store the value in r2 in the memory address [r1]
   strb r3, [r0]           // store the value in r2 in the memory address [r1]
   bl   dowait             // execute dowait
